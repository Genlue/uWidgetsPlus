...
public class SettingsViewModel : ReactiveObject
{
        ...
        IWidgetFactory<Window, UserControl> widgetFactory)
    {
        ...
        var timeAssemblies = GetAssemblies("Clock", "Calendar");
        ...
        var mediaAssemblies = GetAssemblies("Music", "Weather");

        var knownNames = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            "Clock", "Calendar", "Notes", "Reminders", "Folders", "Tools", "Search", "Monitor", "Music", "Weather"
        };
        ...
        var items = new List<PageViewModel>
        {
            ...
            new(typeof(Gallery), SafeParseIcon("M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"), "影音天气", null, mediaAssemblies),
        };
